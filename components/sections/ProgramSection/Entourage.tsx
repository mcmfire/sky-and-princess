...
import { FaAward, FaBible, FaStar, FaUserFriends } from "react-icons/fa";
...
import {
    ...
    PROGRAM_SECTION_ENTOURAGE_BRIDE_PARENTS,
    ...
    PROGRAM_SECTION_ENTOURAGE_FLOWER_BOY, PROGRAM_SECTION_ENTOURAGE_GROOM_PARENTS, PROGRAM_SECTION_ENTOURAGE_GROOMSMEN,
...
const Entourage = () => {
    return (
        <div id="entourage-container" className="flex flex-col items-center w-full px-5 py-10 gap-20 sm:max-xl:gap-10 text-center">
            <h3>Entourage</h3>
                            ...
                            <div className="entourage-card flex flex-col items-center gap-3">
                                ...
                                <div id="groom-parent-container" className="flex flex-col justify-center w-full gap-3">
                                    ...
                                    {PROGRAM_SECTION_ENTOURAGE_GROOM_PARENTS.map((parent, index) => (
                                        <p key={`groom-parent-${index}`} id={`${parent}-${index + 1}`} className="entourage-name mb-3 text-lg">{parent}</p>
                                    ))}
                                </div>
                            </div>
                            <div className="entourage-card flex flex-col items-center gap-3">
