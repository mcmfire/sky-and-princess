...
const Entourage = () => {
    return (
        <div id="entourage-container" className="flex flex-col items-center w-full py-10 gap-20 sm:max-xl:gap-10">
            <h3 className="font-[AmedaRegular] text-5xl -mb-10 sm:max-xl:-mb-5">Entourage</h3>
            <div className="entourage-card-container flex sm:max-lg:flex-col sm:max-lg:items-center max-sm:flex-col sm:justify-center max-sm:items-center sm:gap-20 sm:max-xl:gap-5 max-sm:gap-5 w-full">
            ...
            <div className="entourage-card-container flex sm:max-lg:flex-col sm:max-lg:items-center max-sm:flex-col sm:justify-center max-sm:items-center sm:gap-20 sm:max-xl:gap-5 max-sm:gap-5 w-full">
                {PROGRAM_SECTION_ENTOURAGE.tier_four.map((entourage, index) => (
                    <div key={`${entourage.role}-${index}`} className={`entourage-card flex max-sm:flex-col max-sm:justify-center items-center w-80 h-max p-5 gap-3 text-white bg-gradient-to-tl 
                        ${entourage.role === "COIN" ? "from-yellow-600 to-yellow-500" : ""} 
                        ${entourage.role === "RING" ? "from-sky-300 to-sky-200" : ""}
                        ${entourage.role === "BIBLE" ? "from-yellow-900 to-yellow-600" : ""}
