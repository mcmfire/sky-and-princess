...
const Entourage = () => {
    ...
    return (
        <div id="entourage-container" className="flex flex-col items-center w-full px-5 py-10 gap-20 sm:max-xl:gap-10">
            <h3 className="font-[AmedaRegular] text-5xl -mb-10 sm:max-xl:-mb-5 text-center">Entourage</h3>
